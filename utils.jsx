  ...
  return (
    ...
    >
      <g>
        <path
          fill="#FFF"
          d="M12-0.1c-6.6,0-12,5.4-12,12V24h2.1L4,22l1.9,2L8,22l2,2l2-2l1.9,2l2.1-2l2,2l2-2l2,2h2V11.9C24,5.3,18.6-0.1,12-0.1z    
                M22,20.5L20,19l-2,2l-2-2l-2,2l-2-2l-2,2l-2-2l-2.1,2L4,19l-2,1.5v-8.6c0-5.5,4.5-10,10-10s10,4.5,10,10V20.5z"
        />
        <path
          fill="#FFF"
          d="M16,7.9c-1.7,0-3,1.3-3,3s1.3,3,3,3s3-1.3,3-3S17.7,7.9,16,7.9z M16,12.9c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2  
                 S17.1,12.9,16,12.9z"
        />
        <path
          fill="#FFF"
          d="M8,7.9c-1.7,0-3,1.3-3,3s1.3,3,3,3s3-1.3,3-3S9.7,7.9,8,7.9z M8,12.9c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2 
                   S9.1,12.9,8,12.9z"
        />
      </g>
    </svg>
